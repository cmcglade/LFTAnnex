	...
	class Wolf_Framework_Admin {
		...
		public function display_notice() {
			...
			$wrong_install = sprintf(
				__( 'It seems that <strong>the theme has been installed incorrectly</strong>. Go <a href="%s" target="_blank">here</a> to find instructions about theme installation.', 'wolf' ), 'http://wpwolf.com/common-wordpress-theme-issues/'
				);
