...
array( "type" => "open", "name" => __('Backgrounds', 'wolf') ),
	...
	array( "name" => __('Backgrounds', 'wolf'),
		...
		array( "name" => __('Footer Social Logos Background', 'wolf'),
			"id" =>"footer_socials",
			"desc" => __('This area is visible only if you have installed the <a href="http://wpwolf.com/plugin/wolf-music-network" target="_blank">WolfMusicNetwork plugin</a>.', 'wolf'),
			"type" => "background",
			// 'parallax' => true
			),
	array(  "type" => "section_close"),
