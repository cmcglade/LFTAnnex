...
class WTD_Upcoming_Shows_Widget extends WP_Widget {
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['artist'] = sanitize_text_field( $new_instance['artist'] );
	...
	function form( $instance ) {
		...
		$defaults = array(
			...
			'desc' => '',
			'url' => '',
			'link_text' => __( 'View more dates', 'wolf' ),
			'artist' => '',
		);
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'artist' ) );  ?>"><?php _e( 'Artist slug', 'wolf' ); ?>:</label>
			<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'artist' ) );  ?>" name="<?php echo sanitize_text_field( $this->get_field_name( 'artist' ) ); ?>" value="<?php echo absint( $instance['artist'] ); ?>">
		</p>
		<p>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link_text' ) ); ?>"><?php _e( 'Link to show page text', 'wolf' ); ?>:</label>
			<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'link_text' ) ); ?>" name="<?php echo sanitize_text_field( $this->get_field_name( 'link_text' ) ); ?>" value="<?php echo sanitize_text_field( $instance['link_text'] ); ?>">
		</p>
		<?php
	}
