...
/* --------------------------------------------------------- */
/* !Trim tweet text of media links - 2.0.1 */
/* --------------------------------------------------------- */
...
function mtphr_dnt_twitter_text( $item, $meta ) {
	...
	if( ($_mtphr_dnt_twitter_display_order['image'] == 'on' && mtphr_dnt_twitter_has_image($item)) || ($_mtphr_dnt_twitter_display_order['video'] == 'on' && mtphr_dnt_twitter_has_video($item)) ) {
