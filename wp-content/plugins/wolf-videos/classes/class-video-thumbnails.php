<?php
if ( ! class_exists( 'Wolf_Videos_Video_Thumbnails' ) ) {
	/**
	 * Wolf Videos Video Thumbnail
	 *
	 * Generate thumbnail from youtube and vimeo video
	 *
	 * @author WpWolf
	 * @package WolfVideos/Classes
	 * @since 1.0.3
	 */
	class Wolf_Videos_Video_Thumbnails {

		/**
		 * Wolf_Videos_Video_Thumbnails Constructor.
		 *
		 * @access public
		 * @return void
		 */
	...
	$wolf_videos_do_video_thumbnails = new Wolf_Videos_Video_Thumbnails;
